...
//         {/* Call to action with Calendly side by side */}
//         <div className="mt-16">
...
//                     Give your child the gift of quality care and education
//                   </p>
//                   <button className="inline-flex items-center px-8 py-3 bg-pink-500 text-white rounded-lg shadow-md hover:bg-pink-600 transition-colors duration-200">
//                     Schedule a Visit
...
//                   data-url="https://calendly.com/ablaali1997/30min"
