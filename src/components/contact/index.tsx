...
export const contactMethods: ContactMethod[] = [
  {
    ...
    details: "(206) 371-3011",
    description: "Available for Emergency Care",
    link: "tel:+12063713011",
    linkProps: {},
  },
  {
    icon: <Mail className="w-6 h-6 text-blue-500" />,
    title: "Email Us",
    details: "koosmohamed2@gmail.com",
    description: "Response within 2 hours",
    link: "mailto:koosmohamed2@gmail.com",
    linkProps: {},
  },
  {
    icon: <MapPin className="w-6 h-6 text-yellow-500" />,
    title: "Our Location",
    details: "6532 32nd Ave SW",
    description: "Seattle, WA 98126",
    link: "https://maps.app.goo.gl/qDUy3MDSiPztrfyK8",
